    ...
    <div className="container">
      ...
      <p align="center"> <b><h3>Customer Service Details</h3></b></p>
       ...
       <div className="col-lg-3 mt-2 mb-2">
        ...
        <button className="btn btn-dark float-right" style={{width:'155px',position:"left",
        left:"250px"}}><a href="#" onClick={() =>this.genPDF()} style={{textDecoration:'none', color:'white'}}> Get Report</a></button>
